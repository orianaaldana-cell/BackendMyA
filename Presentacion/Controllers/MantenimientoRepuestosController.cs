...
namespace MyAMIS.Presentacion.Controllers
{
    ...
    [ApiController]
    public class MantenimientoRepuestosController : ControllerBase
    {
        private readonly MyAMISContext _context;

        public MantenimientoRepuestosController(MyAMISContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Borrar(string codigo)
        {
            ...
            return Ok("Depreciación eliminada");
        }
    }
}
